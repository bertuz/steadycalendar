...
class MonthGrid extends StatefulWidget {
  ...
  MonthGrid(this.cal, {super.key});

  @override
  State<StatefulWidget> createState() => _MonthGridState();
}
  ...
  Widget build(BuildContext context) {
    return TableCalendar(
      ...
      selectedDayPredicate: (day) =>
          (widget.cal.dates?.containsKey(day.hashCode) ?? false),
      focusedDay: DateTime.now(),
    );
  }

  _defaultTextStyle({Color? color}) => TextStyle(
